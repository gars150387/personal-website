            ...
            <Stack className="justify-content-center" direction='horizontal' gap={2}>
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <p className="card-text">Hi everyone, my name is Gustavo and I am a Software Developer, My background is based on Marketing and Management.</p>
                        ...
                        <p className="card-text">I always look for new challenges to help me to grow as person as professional</p>
