...
"
      ...
      <TextParallaxContent
        ...
        heading="Yenny on Trend, fashion and lifestyle platform"
      >
        <ExampleContent
      ...
      >
        <ExampleContent heading="GARS Solutions is a modern, feature-rich web application designed to streamline scheduling, appointment management, and payments. Built using a scalable and efficient tech stack, it offers a seamless user experience tailored for businesses and individuals who need to manage schedules, client interactions, and transactions efficiently." url="https://gars.solutions" subheading={<>    
        <li>
          <span className="inline-flex items-center space-x-2">
            <img src="https://img.icons8.com/color/48/react-native.png" alt="React Icon" className="h-6 w-6" />
            <span>Frontend: React (via Vite), React Router, Ant Design, Material UI.</span>
          </span>
        </li>
        <li>
          <span className="inline-flex items-center space-x-2">
            <img src="https://img.icons8.com/color/48/nodejs.png" alt="Node.js Icon" className="h-6 w-6" />
            <span>Backend: Node.js, AWS Lambda.</span>
          </span>
        </li>
        <li>
          <span className="inline-flex items-center space-x-2">
            <img src="https://img.icons8.com/color/48/database.png" alt="Database Icon" className="h-6 w-6" />
            <span>Database and Authentication: Supabase.</span>
          </span>
        </li>
        <li>
          <span className="inline-flex items-center space-x-2">
            <img src="https://img.icons8.com/fluency/48/stripe.png" alt="Stripe Icon" className="h-6 w-6" />
            <span>Payments: Stripe (Stripe.js, React Stripe.js, Stripe Connect.js).</span>
          </span>
        </li>
        <li>
          <span className="inline-flex items-center space-x-2">
            <img src="https://images.squarespace-cdn.com/content/v1/6490d447aaf1c8276eee9f2f/2af05125-1560-48a7-9d7c-83f32acbfa39/Screenshot+2023-08-09+at+11.58.31+AM.png" alt="Calendar Icon" className="h-6 w-6" />
